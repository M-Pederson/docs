---
title: 'Get all starred teams for the User'
api: 'GET https://xh2o-yths-38lt.n7c.xano.io/api:idMy4x2v/team-favourites'
description: 'Get all starred teams for the User Authentication: required'
---
...
<RequestExample>
```bash cURL
curl -X GET https://xh2o-yths-38lt.n7c.xano.io/api:idMy4x2v/team-favourites \
