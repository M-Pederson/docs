...
| **4** | Any §11 queue path without an explicit tier (the default). Since 2026-07-03 `priority_tier|first_notnull:4` stores an explicit tier 0 / 1 instead of coercing it to 4 | live |
