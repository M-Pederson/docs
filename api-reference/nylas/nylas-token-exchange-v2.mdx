...
api: 'POST https://xh2o-yths-38lt.n7c.xano.io/api:s_Mv_Fpv/nylas/token-exchange_v2'
...
<RequestExample>
```bash cURL
curl -X POST https://xh2o-yths-38lt.n7c.xano.io/api:s_Mv_Fpv/nylas/token-exchange_v2 \
