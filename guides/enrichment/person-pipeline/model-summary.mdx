...
Used for evidence-linked, X/Twitter-grounded social insights about a person. Function #12669 moved to Grok 4.5 on 2026-07-11 and locked medium reasoning after direct minimal/medium/high sandbox comparisons. The request uses native OpenRouter web search, two server-tool steps, a \$0.03 loop threshold, six returned search results, strict ZDR, and `data_collection=deny`.

| Function | Temp | Max Tokens | Timeout | Reasoning | Avg Input Tokens | Avg Output Tokens | Cost/Call | Updated |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `get-social-insights` #12669 v1.23 (person social insights \+ verified/held profile URL audit) | 0.2 | 1600 | 90s | medium | _TBD_ | _TBD_ | _TBD_ | 2026-07-11 |
...
graph TD
    ...
    A --> F["#12669 v1.23 get-social-insights<br/>x-ai/grok-4.5 · temp 0.2 · reasoning medium"]
