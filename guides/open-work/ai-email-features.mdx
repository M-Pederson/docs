...
**Being workshopped:** (1) do memories run automatically for every contact as part of the import's AI pass, or stay user-triggered per contact; (2) confirm one-pass multi-subject extraction; (3) combined summary+memory call vs. separate stages for in-window threads; (4) confirm staged bodies as the single transcript source.
