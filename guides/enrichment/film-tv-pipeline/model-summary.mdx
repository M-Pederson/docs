...
Same Flash Lite tier with OpenRouter's `:online` web-search grounding. Used by the tagline generator so it can pull additional context (existing taglines, reviews, marketing angles) beyond the prompt.

| Function | Temp | Max Tokens | Timeout | Avg Input Tokens | Avg Output Tokens | Cost/Call | Updated |
|----------|------|------------|---------|-----------------|------------------|-----------|---------|
| `tagline-generator` #10516 v4 | 0.6 | 100 | 60s | _TBD_ | _TBD_ | _TBD_ | 2026-05-17 |
...
graph TD
    ...
    subgraph "Title cascade (depth 1+)"
      ...
      T2 --> T4["Phase 2 tagline<br/>#10516 v4 google/gemini-3.1-flash-lite:online · temp 0.6"]
...
- `#12833 deep-person-basic v3` — `google/gemini-3.1-pro-preview:online` (deep bio via external `orbiter-enrich-…` microservice)
