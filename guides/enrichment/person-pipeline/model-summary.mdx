...
Used for expertise signal extraction with structured JSON output. Replaced `anthropic/claude-sonnet-4` on 2026-04-05 for cost efficiency — the v2 prompt uses a constrained signals schema that doesn't require deep reasoning.
