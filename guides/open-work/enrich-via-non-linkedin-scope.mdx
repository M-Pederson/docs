...
<Warning>
  Net result: a **junk-named, enrichment-less node** seeds the graph from a bare social handle, and nothing flags it as low-quality. This is exactly the *"Verify master_person creation from a non-LinkedIn profile URL"* item on the [migration freeze checklist](/guides/open-work/orbiter-univers-standalone/enrichment-gcp-migration).
</Warning>
...
- **Related:** [Enrichment GCP Migration](/guides/open-work/orbiter-univers-standalone/enrichment-gcp-migration) · [Person enrichment phases](/guides/enrichment/waterfall/person-enrichment-phases) · [Person enrichment cascade](/guides/open-work/person-enrichment-cascade)
