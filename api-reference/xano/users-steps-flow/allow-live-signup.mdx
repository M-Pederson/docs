---
title: 'Get Allow Live Signup'
api: 'GET https://xh2o-yths-38lt.n7c.xano.io/api:_wjCLRXt/allow/live-signup'
...
<RequestExample>
```bash cURL
curl -X GET https://xh2o-yths-38lt.n7c.xano.io/api:_wjCLRXt/allow/live-signup \
