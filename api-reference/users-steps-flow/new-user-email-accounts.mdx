---
title: 'Get New User Email Accounts'
api: 'GET https://xh2o-yths-38lt.n7c.xano.io/api:_wjCLRXt/new-user/email-accounts'
...
<RequestExample>
```bash cURL
curl -X GET https://xh2o-yths-38lt.n7c.xano.io/api:_wjCLRXt/new-user/email-accounts \
