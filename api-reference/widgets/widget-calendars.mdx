---
title: 'Get all auth user calendars '
api: 'GET https://xh2o-yths-38lt.n7c.xano.io/api:3IvQ7jxX/widget/calendars'
description: 'Get all auth user calendars Authentication: required'
---
...
<RequestExample>
```bash cURL
curl -X GET https://xh2o-yths-38lt.n7c.xano.io/api:3IvQ7jxX/widget/calendars \
