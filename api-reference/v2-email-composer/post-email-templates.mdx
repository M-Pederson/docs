---
title: 'Add email_template record'
api: 'POST https://xh2o-yths-38lt.n7c.xano.io/api:58PjJ6J9/email-templates'
description: 'Add email_template record Authentication: required'
---
...
<RequestExample>
```bash cURL
curl -X POST https://xh2o-yths-38lt.n7c.xano.io/api:58PjJ6J9/email-templates \
