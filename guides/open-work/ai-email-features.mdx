...
**Scope: full AI-on parity.** The backfill also runs signature extraction and thread summaries over the backfilled mail — everything AI-on preprocessing would have produced.
