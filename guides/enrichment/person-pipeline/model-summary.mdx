...
Used for deep-research person bios via the external `orbiter-enrich-…` microservice. Web grounding is now passed as `openrouter:web_search` in the request payload. Migrated off `:online` on 2026-06-04; Kimi was previously retired on 2026-05-17 after repeated external-service parse crashes.
...
graph TD
    ...
    A --> G["#12833 deep-person-basic<br/>google/gemini-3.1-pro-preview + web_search · temp 0.6"]
