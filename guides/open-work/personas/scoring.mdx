...
**Simulated `persona` (754) record** — a representative row for a fictional operator (the same "Dana Okafor" used in the patent documentation; vectors elided). Exact live column set:
...
```json
{
  ...
  "identity_profile_narrative": "Dana Okafor is co-founder and CEO of Torchline Systems, a Series B developer-tools company bringing AI-agent infrastructure to enterprise engineering teams — a staff engineer turned product leader who still works hands-on in the platform.",
  ...
  "soft_skills_narrative": "Appears to be a hands-on technical recruiter-founder: builds and leads senior engineering teams, runs enterprise design partnerships, and closes complex multi-stakeholder deals — the pattern across her roles suggests she turns ambiguous problems into shipped roadmaps.",
  "soft_skills_vector": [-0.0075, 0.0304, 0.0129, "…"],

  "track_record_narrative": "Scaled Torchline from zero to roughly 80 people and eight-figure ARR; earlier shipped a widely adopted open-source CI framework and was an early engineer at two startups that were acquired.",
  ...
  "communication_style_narrative": "Direct, technically precise, and demo-driven — her posts favor concrete examples and written memos over slideware, and her register is warm but concise in one-to-one exchanges.",
  "communication_style_vector": [-0.0043, 0.0221, 0.0166, "…"],

  "community_affiliation_narrative": "Active in the open-source developer-tools and applied-AI scenes; an alum of a 2019 accelerator cohort, and mentors across two founder networks alongside her co-founder Priya Raman.",
  ...
  "persona_sequence_summary": "Dana Okafor is a founder-CEO building AI-agent infrastructure for enterprise engineering teams, with deep expertise in developer tooling, distributed systems, and LLM-agent orchestration. She leads senior teams and enterprise partnerships hands-on, backed by a track record of scaling Torchline to ~80 people and eight-figure ARR after shipping a widely adopted CI framework. Publicly she speaks on agentic workflows and the economics of inference in a direct, demo-driven style, moves in the open-source and applied-AI scenes, and beyond work runs trails and mentors first-time founders. Right now she is raising a Series C, hiring engineering leadership, and seeking regulated-industry design partners.",
  ...
  "graph_context": {
    "person": { "labels": ["Entity", "Person"], "uuid": "b7e2c4f1-…", "name": "Dana Okafor", "current_title": "Co-founder & CEO", "…": "…" },
    "connections": [
      { "edge_type": "FOUNDED", "direction": "outbound", "edge_properties": { "description": "Dana co-founded Torchline Systems in March 2021…", "valid_from": "2021-03", "valid_to": null }, "neighbor": { "labels": ["Entity", "Company"], "name": "Torchline Systems" } },
      "… 33 more 1-hop edges …"
    ]
  }
}
