...
Declared `CONNECTED_ON_*` edges are binary facts and coexist with KNOWS on the same pair — KNOWS is the relationship spine whose strength grows from real interaction.
