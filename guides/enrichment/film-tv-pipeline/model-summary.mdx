...
Used for natural-language edge descriptions written onto FalkorDB `WORKED_ON` edges (Person → Film\_TV). Cheap \+ fast since each call is one sentence per edge.
...
- `#2537 create-llm-person-bios` — `moonshotai/kimi-k2.5` (short \+ long bios)
...
- `#12669 get-social-insights v1.26` — `x-ai/grok-4.5` via #13190 v2.1 (two bounded Exa evidence searches → tool-free social insight synthesis, medium reasoning primary / low reasoning retry)
