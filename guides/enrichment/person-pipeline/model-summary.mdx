...
Used for web-grounded profile image search with identity verification scoring.

| Function | Temp | Max Tokens | Timeout | Avg Input Tokens | Avg Output Tokens | Cost/Call | Updated |
|----------|------|------------|---------|-----------------|------------------|-----------|---------|
| `get-profile-image` #12607 | 0 | 500 | 60s | _TBD_ | _TBD_ | _TBD_ | 2026-03-02 |
...
graph TD
    ...
    A --> F["#12607 get-profile-image<br/>Gemini 3.1 Pro :online · temp 0"]
```
