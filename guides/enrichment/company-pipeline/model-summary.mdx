...
Used for structured extraction and copywriting tasks where deterministic JSON output is critical.

| Function | Temp | Max Tokens | Timeout | Avg Input Tokens | Avg Output Tokens | Cost/Call | Updated |
|----------|------|------------|---------|-----------------|------------------|-----------|---------|
| `llm-company-about` #2545 | 0.2 | — | 30s | _TBD_ | _TBD_ | _TBD_ | 2026-03-26 |
| `scrape_extract_website_data` #2814 | 0.1 | 4000 | 180s | _TBD_ | _TBD_ | _TBD_ | 2026-02-19 |
...
```mermaid
graph TD
    A["#12558 enrich-company-v2"] --> B["#2814 scrape_extract_website_data<br/>Kimi K2 · temp 0.1"]
    ...
    C --> G["#2545 llm-company-about<br/>Kimi K2 · temp 0.2"]
