...
<Note>
  To decide: whether flipping the global toggle later re-syncs account toggles that were never manually overridden, or only seeds accounts connected after the change.
</Note>
