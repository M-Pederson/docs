...
3. **CREATE-CONTACTS v2.** Stub + KNOWS edge + membership row + mem0 kickoff — idempotent on `(user_id, node_uuid)`. No subgraph copy exists; the flow is identical for brand-new and fully-enriched people.
