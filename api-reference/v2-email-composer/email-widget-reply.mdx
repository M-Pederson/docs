---
title: 'Create Email Widget Reply'
api: 'POST https://xh2o-yths-38lt.n7c.xano.io/api:58PjJ6J9/email-widget/reply'
...
<RequestExample>
```bash cURL
curl -X POST https://xh2o-yths-38lt.n7c.xano.io/api:58PjJ6J9/email-widget/reply \
