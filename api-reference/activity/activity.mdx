---
title: 'Get activity for orbits'
api: 'GET https://xh2o-yths-38lt.n7c.xano.io/api:Nj8wpJVw/activity'
description: 'Get activity for orbits Authentication: required'
---
...
<RequestExample>
```bash cURL
curl -X GET https://xh2o-yths-38lt.n7c.xano.io/api:Nj8wpJVw/activity \
