---
title: 'a User adds an email'
api: 'POST https://xh2o-yths-38lt.n7c.xano.io/api:_wjCLRXt/user-add/email'
description: 'a User adds an email Authentication: required'
---
...
<RequestExample>
```bash cURL
curl -X POST https://xh2o-yths-38lt.n7c.xano.io/api:_wjCLRXt/user-add/email \
